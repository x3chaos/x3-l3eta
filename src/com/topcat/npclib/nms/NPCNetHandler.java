...
public class NPCNetHandler extends NetServerHandler {
	...
	public NPCNetHandler(MinecraftServer ms, EntityPlayer entityplayer) {
		super(ms, NPCManager.getNPCNetworkManager(), entityplayer);
	}
	...
	@Override
	public void a(Packet7UseEntity useentity) {
	};
